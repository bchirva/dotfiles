...
function M.setup()
    ...
    local rules = {
        ...
        DiffAdd                  = { bg = colors.success_background, fg = colors.success_foreground },
        DiffChange               = { bg = colors.warning_background, fg = colors.warning_foreground },
        DiffDelete               = { bg = colors.error_background, fg = colors.error_foreground },
        DiffText                 = { bg = colors.warning_background, fg = colors.warning_foreground },
        DiffTextAdd              = { bg = colors.success_background, fg = colors.success_foreground },
        ...
        MatchParen               = { fg = colors.accent, bold = true, italic = true },
        ModeMsg                  = {},
        MsgArea                  = {},
        MsgSeparator             = {},
        MoreMsg                  = {},
        ...
        FloatTitle               = { fg = colors.accent, bold = true },
        FloatFooter              = { fg = colors.info, italic = true },

        Pmenu                    = {},
        PmenuSel                 = { bg = colors.accent, fg = colors.background_base, bold = true },
