...
local user_opts = {
    ...
    windowcontrols_close_hover = theme_colors.warning, -- color of close window control on hover
    windowcontrols_max_hover = theme_colors.secondary,  -- color of maximize window controls on hover
    windowcontrols_min_hover = theme_colors.secondary,  -- color of minimize window controls on hover
    title_color = theme_colors.foreground_highlighted,               -- color of the title (above seekbar)
    cache_info_color = theme_colors.foreground_base,          -- color of the cache information
    seekbarfg_color = theme_colors.primary,           -- color of the seekbar progress and handle
    seekbarbg_color = theme_colors.background_focused,           -- color of the remaining seekbar
    seekbar_cache_color = theme_colors.background_highlighted,       -- color of the cache ranges on the seekbar
    ...
    held_element_color = theme_colors.foreground_faded,        -- color of the element when held down (pressed)
    hover_effect_color = theme_colors.primary,        -- color of a hovered button when hover_effect includes "color"
    thumbnail_border_color = theme_colors.background_buffer,    -- color of the border for thumbnails (with thumbfast)
    thumbnail_border_outline = theme_colors.primary,  -- color of the border outline for thumbnails
