...
local user_opts = {
    ...
    window_title_color = theme_colors.foreground,         -- color of the title in borderless/fullscreen mode
    window_controls_color = theme_colors.foreground,      -- color of the window controls (close, minimize, maximize) in borderless/fullscreen mode
    windowcontrols_close_hover = theme_colors.error, -- color of close window control on hover
    windowcontrols_max_hover = theme_colors.accent_bright, -- color of maximize window controls on hover
    windowcontrols_min_hover = theme_colors.accent_bright, -- color of minimize window controls on hover
    title_color = theme_colors.foreground_bright,         -- color of the title (above seekbar)
    cache_info_color = theme_colors.foreground,           -- color of the cache information
    seekbarfg_color = theme_colors.accent,            -- color of the seekbar progress and handle
    ...
    time_color = theme_colors.foreground,                 -- color of the timestamps (below seekbar)
    chapter_title_color = theme_colors.foreground,        -- color of the chapter title (above seekbar)
    side_buttons_color = theme_colors.foreground,         -- color of the side buttons (audio, subtitles, playlist, etc.)
    middle_buttons_color = theme_colors.foreground,       -- color of the middle buttons (skip, jump, chapter, etc.)
    playpause_color = theme_colors.foreground,            -- color of the play/pause button
    held_element_color = theme_colors.foreground_dim,        -- color of the element when held down (pressed)
    hover_effect_color = theme_colors.accent,         -- color of a hovered button when hover_effect includes "color"
    thumbnail_border_color = theme_colors.background,   -- color of the border for thumbnails (with thumbfast)
    thumbnail_border_outline = theme_colors.accent,   -- color of the border outline for thumbnails
