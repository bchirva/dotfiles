...
local user_opts = {
    ...
    window_title_color = theme_colors.fg_text,         -- color of the title in borderless/fullscreen mode
    window_controls_color = theme_colors.fg_text,      -- color of the window controls (close, minimize, maximize) in borderless/fullscreen mode
    ...
    title_color = theme_colors.fg_highlighted,         -- color of the title (above seekbar)
    cache_info_color = theme_colors.fg_text,           -- color of the cache information
    seekbarfg_color = theme_colors.primary,            -- color of the seekbar progress and handle
    seekbarbg_color = theme_colors.bg_focused,         -- color of the remaining seekbar
    seekbar_cache_color = theme_colors.bg_highlighted, -- color of the cache ranges on the seekbar
    volumebar_match_seek_color = false,                -- match volume bar color with seekbar color (ignores side_buttons_color)
    time_color = theme_colors.fg_text,                 -- color of the timestamps (below seekbar)
    chapter_title_color = theme_colors.fg_text,        -- color of the chapter title (above seekbar)
    side_buttons_color = theme_colors.fg_text,         -- color of the side buttons (audio, subtitles, playlist, etc.)
    middle_buttons_color = theme_colors.fg_text,       -- color of the middle buttons (skip, jump, chapter, etc.)
    playpause_color = theme_colors.fg_text,            -- color of the play/pause button
    held_element_color = theme_colors.fg_faded,        -- color of the element when held down (pressed)
    hover_effect_color = theme_colors.primary,         -- color of a hovered button when hover_effect includes "color"
    thumbnail_border_color = theme_colors.bg_buffer,   -- color of the border for thumbnails (with thumbfast)
